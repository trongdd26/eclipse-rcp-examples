...
public class Security extends EntityWithIntegerKey implements ISecurity {
  ...
  private String fkSecurityDirection;
  private String fkSecurityType;
  ...
  public String getFkSecurityDirection() {
    return fkSecurityDirection;
  }

  public void setFkSecurityDirection(String fkSecurityDirection) {
    this.fkSecurityDirection = fkSecurityDirection;
  }

  public String getFkSecurityType() {
    return fkSecurityType;
  }

  public void setFkSecurityType(String fkSecurityType) {
    this.fkSecurityType = fkSecurityType;
  }
}
