...
public abstract class UtilsArray {
    ...
    /**
     * Concatenates two arrays. The resulting array has component type <code>Object</code>.
     * 
     * @param a1 the first array, which may be null.
     * @param a2 the second array, which may be null.
     * @param clazz component type of the resulting array.
     * 
     * @return the concatenation of the two arrays. Returns an empty array if both input arrays are null.
     */
    public static Object[] concat(Object[] a1, Object[] a2, Class<?> clazz) {
        if (a1 == null || a1.length == 0) {
            if (a2 == null || a2.length == 0) {
                return NO_OBJECTS;
            } else {
                Object[] result = (Object[]) Array.newInstance(clazz, a2.length);
                System.arraycopy(a2, 0, result, 0, a2.length);
                return result;
            }
        } else {
            if (a2 == null || a2.length == 0) {
                Object[] result = (Object[]) Array.newInstance(clazz, a1.length);
                System.arraycopy(a1, 0, result, 0, a1.length);
                return result;
            } else {
                Object[] result = (Object[]) Array.newInstance(clazz, a1.length + a2.length);
                System.arraycopy(a1, 0, result, 0, a1.length);
