...
public class EventHandling {
	...
	public static void postNewSecurityEvent(ViewableSecurity newSecurity) {
		postEvent(newSecurity, TOPIC_NEW_SECURITY);
	}

	public static void postNewSecurityPositionEvent(ViewableSecurityPosition newSecurityPosition) {
	...
	public static ViewableSecurity extractNewSecurity(Event event) {
		return (ViewableSecurity) event.getProperty(TOPIC_NEW_SECURITY);
	}

	public static ViewableSecurityPosition extractNewSecurityPosition(Event event) {
		return (ViewableSecurityPosition) event.getProperty(TOPIC_NEW_SECURITY_POSITION);
	}
